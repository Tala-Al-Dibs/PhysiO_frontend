...
const EditProfile = () => {
  ...
  const API_URL = "http://192.168.88.12:8080/api/";
  const BEARER_TOKEN ="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJUZXN0VXNlciIsImlhdCI6MTc0MjQxNDk0OCwiZXhwIjoxNzQyNTAxMzQ4fQ.1L_dj2LPPjr0NONbFVQiZ1brW1EnhzNZioK1kqORBqI";
